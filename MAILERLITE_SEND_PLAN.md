...
3. Send or preview Email 2 with the SurveyOL closed-test link.
4. Confirm both recipients receive the message and can open the survey.
5. Do not schedule any bulk campaign until the closed test is reviewed.
