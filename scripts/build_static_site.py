...
<div class="wp-content results-hub">
  ...
  <details class="accordion-block">
    ...
    <div class="accordion-content">
      ...
      <p>The regular rhythm is Tuesday-centered. First preliminary reports and refreshes to still-open preliminary reports are prepared on Tuesday morning, and the next survey's placeholder report page is published before the SurveyOL survey launches Tuesday evening. Invitations are sent through the SurveyOL Email collector in daily batches of up to 100 until all eligible participants have been invited.</p>
...
<div class="wp-content">
  ...
  {weekly_structure_list}
  <p class="callout"><strong>Participant-nominated ballot rule:</strong> {participant_ballot_note}</p>
  <p>The regular rhythm is Tuesday-centered: first preliminary reports and refreshes to still-open preliminary reports are prepared Tuesday morning, and the next survey's placeholder report page is published before the SurveyOL survey launches Tuesday evening. Invitations are sent in daily batches of up to 100 until all eligible participants have been invited.</p>
  <p class="callout"><strong>Response rule:</strong> {response_rule_note}</p>
